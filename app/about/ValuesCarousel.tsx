...
const VALUES = [
  {
    ...
    body: "We've turned down placements that didn't meet our HSE bar. A crew that comes home safe is the only KPI that can't be traded.",
    proofLead: "3",
    proof: "contracts declined last year on HSE grounds — and we'd do it again",
  },
  {
    n: "02",
    Icon: IconCheck,
    ...
    proofLead: "99.4%",
    proof: "audit pass rate across 12,000+ document checks a year",
  },
  {
    n: "03",
    Icon: IconUsers,
    title: "People before placements",
    body: "Contractors get paid on time, in their currency, every rotation. Half our database came from word-of-mouth — that's not an accident.",
    proofLead: "1 in 2",
    proof: "contractors joined through a referral from someone on rotation",
  },
];
